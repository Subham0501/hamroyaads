                ...
                <div class="bg-white dark:bg-[#1e293b] rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-[#334155]">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="border-2 border-gray-200 dark:border-[#334155] rounded-xl p-6">
                            ...
                            <label class="block text-base font-semibold text-gray-700 dark:text-[#cbd5e1] mb-3">Section 2 Images (3 images)</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        // Hide all section2 images by default (3 images)
        for (let i = 1; i <= 3; i++) {
            const imgs = previewContainer.querySelectorAll(`#section2-image${i}-display`);
            const placeholders = previewContainer.querySelectorAll(`#section2-placeholder${i}`);
            imgs.forEach(img => {
                if (!uploadedImages.section2 || !uploadedImages.section2[`image${i}`]) {
