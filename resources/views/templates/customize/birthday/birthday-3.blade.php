        ...
        newInput.addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    setTimeout(() => updatePreviewImage(imageType, imageSrc), 100);
                    setTimeout(() => updatePreviewImage(imageType, imageSrc), 300);
                    setTimeout(() => updatePreviewImage(imageType, imageSrc), 1000);
                };
