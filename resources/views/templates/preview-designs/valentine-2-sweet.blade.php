{{-- Valentine 2: Sweet Affection - Soft Pastel Layout --}}
<div class="min-h-screen bg-gradient-to-br {{ $templateData['bg'] }}">
    <div class="min-h-screen flex items-center justify-center px-12 py-32">
        <div class="max-w-5xl mx-auto">
            <div class="bg-white/90 dark:bg-[#0f172a]/90 backdrop-blur-xl rounded-[3rem] shadow-2xl p-20 border-4 border-white/50">
                <div class="text-center space-y-12">
                    <div class="flex justify-center">
                        <div class="relative">
                            <div class="absolute inset-0 rounded-full blur-2xl opacity-40" style="background-color: {{ $templateData['color'] }};"></div>
                            <div class="relative w-40 h-40 rounded-full flex items-center justify-center shadow-xl border-4 border-white/60" style="background-color: {{ $templateData['color'] }};">
