{{-- Father's Day Template 1: Classic Appreciation - Bold Header Layout with Dates --}}
@php
...
<div class="min-h-screen bg-gradient-to-br {{ $bg }}" data-theme-color="{{ $color }}" id="template-container" style="--theme-color: {{ $color }};">
    ...
    <section id="home" class="relative min-h-screen flex items-center justify-center px-12 py-32 overflow-hidden pt-20">
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 bg-gradient-to-br" style="background: linear-gradient(135deg, {{ $color }}40, {{ $color }}20);"></div>
                    </div>
        <div class="max-w-6xl mx-auto text-center space-y-16 relative z-10">
            <div class="mb-12 animate-fade-in">
                <div class="inline-flex items-center justify-center w-48 h-48 rounded-full shadow-2xl mb-12 border-8 border-white/50 animate-scale-in" style="background-color: {{ $color }};">
            ...
            <div class="space-y-8 animate-slide-up">
                <div class="inline-block px-8 py-4 rounded-2xl backdrop-blur-md border-2 border-white/30 mb-6" style="background-color: {{ $color }}40;">
                    <p id="preview-subheading" class="text-2xl font-bold uppercase tracking-wider text-white">{{ $templateData['defaults']['subheading'] ?? 'On This Special Day' }}</p>
            </div>
                <div class="mb-6">
                    <span class="text-sm font-semibold" style="color: {{ $color }}80;">{{ $currentDate }}</span>
                </div>
                <h1 id="preview-heading" class="text-8xl md:text-[10rem] lg:text-[12rem] font-black leading-[0.9]" style="color: {{ $color }};">
                    {{ $templateData['defaults']['heading'] ?? 'To My Amazing Father' }}
                </h1>
            </div>
            </div>
        </section>
        
    <!-- Message Section - Split Layout -->
    <section id="story" class="bg-white dark:bg-[#0f172a] py-32 px-8">
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="space-y-6 animate-slide-up">
                        ...
                        <span class="text-sm font-bold uppercase tracking-wider" style="color: {{ $color }};">Message</span>
                    </div>
